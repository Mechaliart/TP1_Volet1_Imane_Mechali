...
public class GrandeTortue : MonoBehaviour
{
...
public void OnTriggerEnter2D(Collider2D collision) {
   ...
   if (collision.gameObject.tag ==  scriptTexte.couleurChoisie) {
       ...
       collision.gameObject.GetComponent<Gestiontortues>().DesactiverTortue();
       scriptTexte.Redmarrer();
       //active l'animation de la tortue
       anim.SetTrigger("tortuee");
